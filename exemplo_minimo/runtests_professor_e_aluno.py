...
class TestStringMethods(unittest.TestCase):
    ...
    def test_002_aluno_por_id(self):
        ...
        self.assertEqual(type(conteudo),dict)
        self.assertIn('nome',conteudo)#o dicionario conteudo, que
                                      #veio do servidor, tem que ter a chave nome
    ...
    def test_006_id_inexistente(self):
        ...
        #alem do codigo de status, tb quero que seja retornado
        # um dicionario com erro. Esse dicionario tem a chave
        # 'erro', com o valor 'aluno nao encotrado'
