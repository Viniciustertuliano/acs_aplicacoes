...
class TestStringMethods(unittest.TestCase):
    ...
    #/sinalizar_interesse/9/3/ significa que 9 está interessado(a) em 3

    #esse teste verifica se a chamada /sinalizar_interesse/pessoa_a/pessoa_b
    ...
    3 se interessa por 9,4,2
    2, por 9 e 3.
    Portanto, existe match entre 3 e 2
